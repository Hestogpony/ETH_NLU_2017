...
class LstmCell:
    def __init__(self):
        ...
        HID_HID = [cfg['hidden_size'], cfg['hidden_size']]
        IN_HID = [cfg['embedding_size'], cfg['hidden_size']]
        HID = cfg['hidden_size']
    ...
    def __call__(self, X, state, scope=None):
        ...
        We follow the tf documentation on RNNCell:
          ...
          * **state** has shape (batch_size x hidden_size, batch_size x hidden_size)
        ...
        # Broadcasting to the rescue again!
